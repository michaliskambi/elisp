...
(defconst pascal-units-paths
  (append
    (list
      ...
      (castle-engine-path "src/base_rendering/")
      (castle-engine-path "src/images/")
      (castle-engine-path "src/transform/")
      (castle-engine-path "src/transform/")
      ...
      (castle-engine-path "src/scene/")
      (castle-engine-path "src/scene/x3d/")
...
(defun kam-cge-api-upgrades ()
  ...
  (save-excursion
    ...
    (kam-beg-of-buf) (query-replace-regexp "ApplicationData(\\\\'\\([^']*\\)\\\\')" "\\\\'castle-data:/\\1\\\\'") ;; in php
...
(defun kam-www-fix ()
  (interactive)
  (save-excursion
    (kam-beg-of-buf) (query-replace-regexp "<a href=\"http://michalis.ii.uni.wroc.pl/cge-www-preview/apidoc/html/\\([^\"]+\\)\">\\([^<]+\\)</a>" "<?php api_link('\\2', '\\1'); ?>")
    (kam-beg-of-buf) (query-replace-regexp "<a href=\"https://castle-engine.io/apidoc/html/\\([^\"]+\\)\">\\([^<]+\\)</a>" "<?php api_link('\\2', '\\1'); ?>")
    (kam-beg-of-buf) (query-replace-regexp "<a href=\"https://castle-engine.io/apidoc-unstable/html/\\([^\"]+\\)\">\\([^<]+\\)</a>" "<?php api_link('\\2', '\\1'); ?>")
  )
)
