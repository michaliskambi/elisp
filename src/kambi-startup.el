...
;;
;; This is a central file, it includes all other Kambi
;; EmacsLisp customization files. I try to keep my ~/.emacs
;; minimal, to be able to easily transfer my configuration
;; to other system.
...
;; --------------------------------------------------------------
;; mnostwo roznych moich drobnych ulepszen/dostosowan Emacsa do siebie
...
;; grep (add "-i" to be case insensitive)
(require 'compile)
...
(global-set-key (kbd "<S-f9>") 'kam-build-immediate)
